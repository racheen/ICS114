...
<jsp:useBean id="salescoRecordsA" type="java.sql.ResultSet" scope="request" />
<jsp:useBean id="salescoRecordsB" type="java.sql.ResultSet" scope="request" />
<jsp:useBean id="salescoRecordsC" type="java.sql.ResultSet" scope="request" />
    ...
    <section id="services2" class="services bg-success">
        <div class="container">
            <div class="row text-center">
                ...
                <h1 align="center">Sales Commission Records for Code A</h1>
		...
		<% while (salescoRecordsA.next()) { %>
		<tr align="center">
			<td><%=salescoRecordsA.getInt("id") %></td>
			<td><%=salescoRecordsA.getString("name") %></td>
			<td><%=salescoRecordsA.getDouble("amount") %></td>
			<td><%=salescoRecordsA.getDouble("grossCommission") %></td>
			<td><%=salescoRecordsA.getDouble("commission") %></td>
			<td><%=salescoRecordsA.getDouble("takeHome") %></td>
		</tr>
		<% } %>
	</table>
</div>
		...
		<% } %>
                ...
                <h1 align="center">Sales Commission Records for Code C</h1>
                <div class="table-responsive">
						<table class="table table-striped">
		<tr>
			<th>Transaction ID</th>
		...
		<% while (salescoRecordsC.next()) { %>
		<tr align="center">
			<td><%=salescoRecordsC.getInt("id") %></td>
			<td><%=salescoRecordsC.getString("name") %></td>
			<td><%=salescoRecordsC.getDouble("amount") %></td>
			<td><%=salescoRecordsC.getDouble("grossCommission") %></td>
			<td><%=salescoRecordsC.getDouble("commission") %></td>
			<td><%=salescoRecordsC.getDouble("takeHome") %></td>
		</tr>
		<% } %>
	</table>
      </div>
