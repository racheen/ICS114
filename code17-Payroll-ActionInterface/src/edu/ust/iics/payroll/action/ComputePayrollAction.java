...
public class ComputePayrollAction implements TaxRate, Action{
...
//		setPayRate(1000);
		...
		if ((lastName.trim().length() == 0) || (firstName.trim().length() == 0) || (empId.trim().length() == 0) || hoursWorked < 0 || payRate <= 0){
