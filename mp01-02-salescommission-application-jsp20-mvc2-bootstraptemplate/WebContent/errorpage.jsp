...
<body>
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            <a id="menu-close" href="#top" class="btn btn-light btn-lg pull-right toggle"><i class="fa fa-times"></i></a>
    ...
    <header id="top" class="header">
        <div class="text-vertical-center">
            <h1 sytle="color:red">ERROR PAGE</h1>
            <h3>Please make sure you've entered a valid input.</h3>
            <br>
            <a href="index.jsp" class="btn btn-dark btn-lg">GO BACK TO HOME PAGE</a>
        </div>
    </header>
